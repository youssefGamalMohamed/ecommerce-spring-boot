...
public interface ICategoryController {
    ...
    ResponseEntity<?> addNewCategory(@RequestBody PostCategoryRequestBody categoryRequestBody);
    ...
    ResponseEntity<?> updateById(@PathVariable("id") Long categoryId , @RequestBody PutCategoryRequestBody updatedBody);
