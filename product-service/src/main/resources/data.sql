...
-- Assuming category_id corresponds to the ID in the external category-service
INSERT INTO `category` (`id`, `name`, `product_id`, `created_at`, `updated_at`) VALUES
(1, 'Electronics', 1, NOW(), NOW()),   -- iPhone 14 -> Electronics
(2, 'Smartphones', 1, NOW(), NOW()),   -- iPhone 14 -> Smartphones
(1, 'Electronics', 2, NOW(), NOW()),   -- Samsung Galaxy S23 -> Electronics
(2, 'Smartphones', 2, NOW(), NOW()),   -- Samsung Galaxy S23 -> Smartphones
(1, 'Electronics', 3, NOW(), NOW()),   -- Dell XPS 13 -> Electronics
(3, 'Laptops', 3, NOW(), NOW()),       -- Dell XPS 13 -> Laptops
(1, 'Electronics', 4, NOW(), NOW()),   -- Sony WH-1000XM5 -> Electronics
(4, 'Audio Devices', 4, NOW(), NOW()), -- Sony WH-1000XM5 -> Audio Devices
(5, 'Home Appliances', 5, NOW(), NOW()),-- Dyson V11 -> Home Appliances
(6, 'Gaming Consoles', 6, NOW(), NOW()), -- PlayStation 5 -> Gaming Consoles
(1, 'Electronics', 7, NOW(), NOW()),   -- MacBook Pro -> Electronics
(3, 'Laptops', 7, NOW(), NOW()),       -- MacBook Pro -> Laptops
(2, 'Smartphones', 8, NOW(), NOW()),   -- Google Pixel 7 Pro -> Smartphones
(7, 'Smart Home Devices', 9, NOW(), NOW()), -- Amazon Echo Dot -> Smart Home Devices
(1, 'Electronics', 10, NOW(), NOW()),  -- Samsung QLED TV -> Electronics
(8, 'TVs', 10, NOW(), NOW()),          -- Samsung QLED TV -> TVs
(1, 'Electronics', 11, NOW(), NOW()),  -- HP Envy -> Electronics
(3, 'Laptops', 11, NOW(), NOW()),      -- HP Envy -> Laptops
(1, 'Electronics', 12, NOW(), NOW()),  -- Bose SoundLink -> Electronics
(4, 'Audio Devices', 12, NOW(), NOW()),-- Bose SoundLink -> Audio Devices
(2, 'Smartphones', 13, NOW(), NOW()),  -- Xiaomi Mi 11 -> Smartphones
(9, 'Cameras', 14, NOW(), NOW()),      -- Sony A7 III -> Cameras
(10, 'Wearables', 15, NOW(), NOW()),   -- Apple Watch -> Wearables
(11, 'Kitchen Appliances', 16, NOW(), NOW()), -- Nespresso -> Kitchen Appliances
(12, 'Fitness & Health Devices', 17, NOW(), NOW()), -- Fitbit -> Fitness & Health Devices
(13, 'Tablets', 18, NOW(), NOW()),     -- Microsoft Surface -> Tablets
(9, 'Cameras', 19, NOW(), NOW()),      -- GoPro -> Cameras
(5, 'Home Appliances', 20, NOW(), NOW()), -- LG Washing Machine -> Home Appliances
(4, 'Audio Devices', 21, NOW(), NOW()), -- JBL Charge -> Audio Devices
(6, 'Gaming Consoles', 22, NOW(), NOW()), -- Nintendo Switch -> Gaming Consoles
(9, 'Cameras', 23, NOW(), NOW()),      -- Canon EOS R5 -> Cameras
(3, 'Laptops', 24, NOW(), NOW()),      -- Asus ROG -> Laptops
(11, 'Kitchen Appliances', 25, NOW(), NOW()), -- KitchenAid -> Kitchen Appliances
(14, 'Computer Accessories', 26, NOW(), NOW()), -- Razer DeathAdder -> Computer Accessories
(7, 'Smart Home Devices', 27, NOW(), NOW()), -- Nest Thermostat -> Smart Home Devices
(6, 'Gaming Consoles', 28, NOW(), NOW()), -- PlayStation VR2 -> Gaming Consoles
(15, 'Smart Home Devices', 29, NOW(), NOW()), -- Philips Hue -> Smart Home Devices
(16, 'Automotive Accessories', 30, NOW(), NOW()); -- Tesla Charger -> Automotive Accessories
